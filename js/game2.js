...
function startlevel(event){
	document.getElementById('level_title').innerHTML = 'Slaap lekker, word wakker!';
...
function wakker(event) {
	document.getElementById('level_title').innerHTML = 'Je word wakker en herinnert je niets meer.... Wat ga je nu doen?';
...
function Debus(event){
	document.getElementById('level_title').innerHTML = 'Je ziet de bus die je nodig hebt. Waar is je tas?';
